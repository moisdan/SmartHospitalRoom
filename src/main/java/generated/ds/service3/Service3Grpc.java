...
public final class Service3Grpc {
  ...
  private static volatile io.grpc.MethodDescriptor<generated.ds.service3.RequestMessage,
      generated.ds.service3.ResponseMessage> getService3DoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "service3_do",
      requestType = generated.ds.service3.RequestMessage.class,
      responseType = generated.ds.service3.ResponseMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<generated.ds.service3.RequestMessage,
      generated.ds.service3.ResponseMessage> getService3DoMethod() {
    io.grpc.MethodDescriptor<generated.ds.service3.RequestMessage, generated.ds.service3.ResponseMessage> getService3DoMethod;
      ...
      synchronized (Service3Grpc.class) {
        if ((getService3DoMethod = Service3Grpc.getService3DoMethod) == null) {
          Service3Grpc.getService3DoMethod = getService3DoMethod = 
              io.grpc.MethodDescriptor.<generated.ds.service3.RequestMessage, generated.ds.service3.ResponseMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "service3.Service3", "service3_do"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  generated.ds.service3.RequestMessage.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  generated.ds.service3.ResponseMessage.getDefaultInstance()))
  ...
  public static abstract class Service3ImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void service3Do(generated.ds.service3.RequestMessage request,
        io.grpc.stub.StreamObserver<generated.ds.service3.ResponseMessage> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                generated.ds.service3.RequestMessage,
                generated.ds.service3.ResponseMessage>(
  ...
  public static final class Service3BlockingStub extends io.grpc.stub.AbstractStub<Service3BlockingStub> {
    ...
    /**
     */
    public generated.ds.service3.ResponseMessage service3Do(generated.ds.service3.RequestMessage request) {
  ...
  public static final class Service3FutureStub extends io.grpc.stub.AbstractStub<Service3FutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<generated.ds.service3.ResponseMessage> service3Do(
        generated.ds.service3.RequestMessage request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SERVICE3_DO:
          serviceImpl.service3Do((generated.ds.service3.RequestMessage) request,
              (io.grpc.stub.StreamObserver<generated.ds.service3.ResponseMessage>) responseObserver);
          break;
        default:
